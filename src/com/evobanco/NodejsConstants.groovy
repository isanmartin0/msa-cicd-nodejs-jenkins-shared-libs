...
class NodejsConstants {
    ...
    static final NODEJS_PACKAGE_TAG_VARIABLE = 'NODEJS_PACKAGE_TAG'
    static final NODEJS_PACKAGE_TARBALL_VARIABLE = 'NODEJS_PACKAGE_TARBALL'
    static final NODEJS_IS_SCOPED_PACKAGE_VARIABLE = 'NODEJS_IS_SCOPED_PACKAGE'
